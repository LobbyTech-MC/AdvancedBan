package com.balugaq.advancedban.core.services;

import com.balugaq.advancedban.api.Language;
        ...
        do {
            if (!languages.hasNext()) {
                if (!FAILED_PATHS.contains(path)) {
                    AdvancedBan.getInstance().getLogger().severe("No localization found for path: " + path);
