...
public class Debug {
    ...
    public static void log(@NotNull String message) {
        init();
        plugin.getServer().getConsoleSender().sendMessage("[" + AdvancedBan.getInstance().getName() + "] " + ChatColor.translateAlternateColorCodes('&', message));
    }
    ...
    public static void init() {
        if (plugin == null) {
            plugin = AdvancedBan.getInstance();
        }
    }
}
